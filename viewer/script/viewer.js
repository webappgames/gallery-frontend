    ...
    (function (Objects) {
        var Button = (function (_super) {
            ...
            Button.prototype.handlePointerPress = function (event, pickResult) {
                ...
                this.redrawPosterTexture();
                var mesh = this.getBabylonMesh(GALLERY.Viewer.scene);
...
function createStairsMesh(name, stairs_count, isFull, scene) {
    ...
    for (var i = 0; i < stairs_count; i++) {
        ...
        i2 = (Math.floor(i / 2) * 2);
        var top_2 = new BABYLON.Vector3(1 - (i1 / stairs_count) - 0.5, (i2) / stairs_count, 0);
        if (isFull) {
            bottom_y = 0;
        }
        else {
        ...
        pathTopA.push(top_2.add(a));
        pathTopB.push(top_2.add(b));
...
(function (GALLERY) {
    ...
    (function (Viewer) {
        function createScene(engine, canvas) {
            ...
            Viewer.scene.onPointerDown = function (evt, pickResult) {
                pointerDown = true;
                if (Viewer.MODE == 'WEB') {
                    //r('down');
...
(function (GALLERY) {
    ...
    (function (Viewer) {
        ...
        Viewer.onPointerClick = onPointerClick;
    })(Viewer = GALLERY.Viewer || (GALLERY.Viewer = {}));
})(GALLERY || (GALLERY = {}));
/// <reference path="reference.ts" />
var GALLERY;
